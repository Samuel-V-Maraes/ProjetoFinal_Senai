...
<footer class="af-footer">
    <div class="af-footer__container">
        ...
        <div class="af-footer__col af-footer__about">
            <a href="index.php"><img src="images/logo-alta-forma.png" alt="Academia Alta Forma" class="af-footer__logo"></a>
        ...
        <div class="af-footer__col">
            ...
            <ul class="af-footer__list af-footer__list--chevron">
                <li><i class="fas fa-chevron-right"></i> <a href="index.php">Página Inicial</a></li>
                <li><i class="fas fa-chevron-right"></i> <a href="academia.php">Nossa Academia</a></li>
                <li><i class="fas fa-chevron-right"></i> <a href="produtos.php">Nossos Produtos</a></li>
                <li><i class="fas fa-chevron-right"></i> <a href="contato.php">Fale Conosco</a></li>
            </ul>
        </div>
