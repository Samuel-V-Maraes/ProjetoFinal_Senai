...
<section class="py-5 bg-white" style="background:var(--bg-panel);">
  <div class="container py-4 bg-white">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <img src="images\ChatGPT Image 14 de mai. de 2026, 21_41_33.png" class="w-200" style="height:360px;object-fit:cover;" alt="Especialização em treino de força">
      </div>
      <div class="col-md-6">
        <img src="images\ChatGPT Image 14 de mai. de 2026, 21_43_05.png" class="w-200" style="height:360px;object-fit:cover;" alt="Especialização em treino funcional">
      </div>
    </div>
  </div>
</section>
