...
<header class="hero" style="background-image:url('images/image.png');">
  <div class="hero-slide is-active" style="background-image:url('images/image.png');"></div>
  <div class="hero-slide" style="background-image:url('images/home2.png');"></div>
  ...
  <div class="container bg-white">
    <div class="row g-5 align-items-center">
      <div class="col-lg-5">
        <div class="row g-3">
          <div class="col-7">
            <img src="images/img2.png" class="rounded w-100" style="height:320px;object-fit:cover;" alt="Treino funcional">
          </div>
          <div class="col-5 d-flex align-items-end">
            <img src="images/img3.png" class="rounded w-100" style="height:220px;object-fit:cover;" alt="Musculação">
          </div>
        </div>
      </div>
      <div class="col-lg-7">
...
<section class="py-5 bg-light" style="background:var(--bg-panel);">
  <div class="container py-4 bg-white">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <img src="images/ChatGPT%20Image%2014%20de%20mai.%20de%202026,%2021_41_33.png" class="rounded w-200" style="height:360px;object-fit:cover;" alt="Especialização em treino de força">
      </div>
      <div class="col-md-6">
        <img src="images/ChatGPT%20Image%2014%20de%20mai.%20de%202026,%2021_43_05.png" class="rounded w-200" style="height:360px;object-fit:cover;" alt="Especialização em treino funcional">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      ...
      <div class="col-lg-6 bg-white">
        <img src="images/img4.png" class="rounded w-300" style="height:440px;object-fit:cover;" alt="Treino de especialidade">
      </div>
    </div>
  </div>
</section>
